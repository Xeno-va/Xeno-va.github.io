---
title: "Opportunity Mining: Finding and Validating Technical Opportunities in Public Data Using Machine Learning and Large-Scale Data Aggregation"
...
These corpora are the foundation the whole system is built on. What sits on top of them — the tools that rank, score, and qualify at scale — is proprietary and not shared here; what follows is the base layer and two real examples of the approach working against it. More will be added to this section as additional tools are built, tested, and analyzed.
...
More is under development. Most of what this base layer could support will take time and testing to realize, and more will be posted here as it does.
